...
*/
export default class DarkRing {
    constructor(position = {x: 0, y: 0}, active = true, rarityClass = RARE_PROB_LEVEL_1) {
     ...
     * @param  {Number}       value The number to be subtracted to the visible ratio
     */
